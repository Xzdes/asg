...
Добро пожаловать в ASG! Этот краткий гайд поможет вам начать использовать ASG в вашем Rust-проекте.
...
## 🚀 Использование ASG в своём проекте

Чтобы подключить ASG как зависимость, добавьте его в `Cargo.toml`:
