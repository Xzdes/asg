# NodeType — ASG Node Types

In ASG, each node in the ASG (Abstract Syntax Graph) has a type called `NodeType` that defines its semantics.  
...
🎯 Now you know all the node types you can use in the ASG ASG!