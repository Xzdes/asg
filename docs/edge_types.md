# EdgeType — ASG Edge Types

In ASG, each edge in the ASG (Abstract Syntax Graph) has a type called `EdgeType` that defines its semantics.  
...
🎯 Now you know all the edge types you can use in the ASG ASG!