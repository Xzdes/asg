# VSCode Plugin для ASG (заглушка)

Этот каталог предназначен для разработки плагина VSCode для поддержки языка ASG.
...
- Интеграция с компилятором ASG для запуска проверки типов и компиляции в LLVM/Wasm.
