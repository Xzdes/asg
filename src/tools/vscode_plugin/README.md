# VSCode Plugin for ASG (Stub)

This directory is reserved for developing the VSCode plugin to support the ASG language.
...
- Integration with the ASG compiler to run type checking and compile to LLVM/Wasm.
